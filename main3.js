    ...
    createUpgrades() {
        let upgrades = {
            ...
            "sponsored": {
                ...
                icon: "question",
                cost: function(owned) {
                    return Math.floor(50 * Math.pow(1.15,owned))
                }
            },
            "research": {
                ...
                rate: 4,
                cost: function(owned) {
                    return Math.floor(200 * Math.pow(1.1,owned))
                }        
            },
            "bots": {
                name: "Buy Bots",
                ...
                rate: 10,
                cost: function(owned) {
                    return Math.floor(500* Math.pow(1.07,owned))
                }  
            },
            "giveaway": {
                name: "Giveaway",
                ...
                rate: 40,
                cost: function(owned){
                    return Math.floor(1000* Math.pow(1.11,owned))
                }
            ...
            "youtube": {
                ...
                rate: 100,
                cost: function(owned) {
                    return Math.floor(4000* Math.pow(1.09,owned))
                }
            },
            "apology": {
                name: "Apology Video",
                ...
                rate: 400,
                cost: function(owned) {
                    return Math.floor(10000* Math.pow(1.07,owned))
                }
            ...
            "interns": {
                ...
                rate: 5000,
                cost: function(owned) {
                    return Math.floor(15000* Math.pow(1.13,owned))
                }
            },
            ...
            "tv": {
                ...
                rate: 66666,
                cost: function(owned){
                    return Math.floor(40000* Math.pow(1.15,owned))
                }
            }
...
class Instructions extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.bitmapText(160, CENTER_Y - 80, "type-y", "First to 60,666 wins!", 32);
